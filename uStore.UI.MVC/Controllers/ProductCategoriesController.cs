...
namespace uStore.UI.MVC.Controllers
{
    public class ProductCategoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ProductCategoryID,ProductID,CategoryID")] ProductCategory productCategory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProductCategoryID,ProductID,CategoryID")] ProductCategory productCategory)
        {
            if (ModelState.IsValid)
            {
